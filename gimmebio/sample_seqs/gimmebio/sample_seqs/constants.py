...
SAUREUS_GENOME_FILENAME = data_file('s_aureus.GCF_000013425.1_ASM1342v1_genomic.fna')
SAUREUS_GENE_ANNOTATION_FILENAME = data_file('s_aureus.GCF_000013425.1_ASM1342v1_feature_table.txt')
